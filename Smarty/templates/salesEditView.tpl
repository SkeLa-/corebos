...
<script type="text/javascript" src="include/js/FieldDependency.js"></script>
{if $PICKIST_DEPENDENCY_DATASOURCE neq ''}
<script type="text/javascript">

	jQuery(document).ready(function() {ldelim} (initFD({$PICKIST_DEPENDENCY_DATASOURCE},'{$USER_ROLE}')) {rdelim});
